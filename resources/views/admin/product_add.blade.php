...
<form action="" method="post" class="form form-horizontal" id="form-product-add">
  ...
  <div class="row cl">
    <label class="form-label col-xs-2"><span class="c-red">*</span>简介：</label>
    <div class="formControls col-xs-5">
  ...
  <div class="row cl">
    <label class="form-label col-xs-2">类别：</label>
    <div class="formControls col-xs-5"> <span class="select-box" style="width:150px;">
  ...
  <div class="row cl">
    <label class="form-label col-xs-2">预览图：</label>
    <div class="formControls col-xs-5">
      ...
      <input type="file" name="preview" id="input_id" style="display: none;" onchange="return uploadImageToServer('input_id','images', 'preview_id');" />
    </div>
  </div>
  <div class="row cl">
    <label class="form-label col-xs-2">详细内容：</label>
    <div class="formControls col-8">
      <script id="editor" type="text/plain" style="width:100%; height:400px;"></script>
    </div>
  </div>
  <div class="row cl">
    <label class="form-label col-xs-2">产品图片：</label>
    <div class="formControls col-8">
      ...
      <input type="file" name="preview" id="input_id1" style="display: none;" onchange="return uploadImageToServer('input_id1','images', 'preview_id1');" />
      ...
      <input type="file" name="preview" id="input_id2" style="display: none;" onchange="return uploadImageToServer('input_id2','images', 'preview_id2');" />
      ...
      <input type="file" name="preview" id="input_id3" style="display: none;" onchange="return uploadImageToServer('input_id3','images', 'preview_id3');" />
      ...
      <input type="file" name="preview" id="input_id4" style="display: none;" onchange="return uploadImageToServer('input_id4','images', 'preview_id4');" />
      ...
      <input type="file" name="preview" id="input_id5" style="display: none;" onchange="return uploadImageToServer('input_id5','images', 'preview_id5');" />
    </div>
  </div>
  <div class="row cl">
...
@section('js')
  <script src="/admin/js/uploadFile.js"></script>
